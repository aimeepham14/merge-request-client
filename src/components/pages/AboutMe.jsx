export default function AboutMe(){
    ...
    return(
        <div className="bg-[#1C1C1C] mx-auto max-w-screen h-screen">
            ...
            <div className="bg-[#1C1C1C] mx-auto max-w-screen" >
                <p className="text-primary text-4xl font-code mt-8 underline" >Meet The Team</p>
            </div>
            <div className="bg-[#1C1C1C] mx-auto max-w-screen h-screen flex flex-row justify-center hidden sm:flex">
            ...
            <div className="bg-[#1C1C1C] mx-auto max-w-screen flex flex-col justify-center">
